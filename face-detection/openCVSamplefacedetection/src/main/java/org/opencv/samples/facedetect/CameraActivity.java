...
public class CameraActivity extends AppCompatActivity implements PortraitCameraBridgeViewBase.CvCameraViewListener2 {
    ...
    private BaseLoaderCallback loaderCallback = new BaseLoaderCallback(this) {
        ...
        public void onManagerConnected(int status) {
            String TAG = new StringBuilder(_TAG).append("onManagerConnected").toString();   //문자열을 저장하고, 관리하는 클래스. 단일 스레드 환경에서 사용
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                builder.setMessage("얼굴 검출을 시도합니다. 카메라 정면을 바라보세요..")  //현재 여기 실행 완료.
    ...
    public void RunClientActivity(){                                    //클라이언트 activity 시작
    ...
    public void RunAdministratorActivity(){                                 //어드민 activity 시작부분
